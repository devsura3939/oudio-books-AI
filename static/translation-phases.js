(function(root, factory) {
    ...
    function promptFor(stage, {source, draft, baseline, target, before, after, glossary, issues = []}) {
        ...
        const rules = target === 'ka' ? 'Natural literary Georgian syntax: Series II Aorist Ergative (-მა); Series III Dative (-ს); experiencer verbs Dative; numerals/quantifiers require singular nouns (სამი წიგნი); privatives prefer უ-...-ოდ (უეჭველად); specific action verbs over გაკეთება; version markers (დაიწერა, აუშენა); ablative -გან; participials over რომელიც; prohibitive ნუ; drop oblique adjective -ი; deictic preverbs; dialogue quotatives (-ო).' : 'Use idiomatic English with source-faithful tense, pronouns and punctuation.';
