    ...
    try:
        if genai is not None:
            ...
            sys_inst = (
                ...
                "44. MENTAL & COGNITIVE IDIOMS: 'lost mind' -> 'ჭკუიდან შეიშალა' (NOT '*დაკარგა თავისი გონება'), 'make up mind' -> 'გადაწყვიტა', 'change mind' -> 'გადაიფიქრა', 'keep in mind' -> 'გაითვალისწინეთ / გახსოვდეთ', 'cross mind' -> 'აზრად მოუვიდა'.\n"
                "45. SENSORY & GAZE COLLOCATIONS: 'catch eye' -> 'თვალი მოჰკრა / ყურადღება მიიპყრო' (NOT '*დაიჭირა მისი თვალი'), 'lay eyes on' -> 'თვალი შეავლო', 'keep an eye on' -> 'თვალყური ადევნეთ', 'in the blink of an eye' -> 'თვალის დახამხამებაში'.\n"
...
def translate_with_local_llm(
    ...
    try:
        ...
        sys_inst = (
            ...
            "11. Mental idioms: 'lost mind' -> 'ჭკუიდან შეიშალა', 'make up mind' -> 'გადაწყვიტა', 'change mind' -> 'გადაიფიქრა'.\n"
            "12. Sensory gaze: 'catch eye' -> 'თვალი მოჰკრა', 'lay eyes on' -> 'თვალი შეავლო', 'in blink of eye' -> 'თვალის დახამხამებაში'.\n"
